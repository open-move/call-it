...
function PulsingRow({ columns, count }: { columns: string; count: number }) {
  return (
    <div className={`grid ${columns} items-center gap-4 px-3 py-2.5`}>
    ...
    <div className="overflow-hidden rounded-md bg-transparent py-0 shadow-none ring-0 lg:bg-card">
      {Array.from({ length: rowCount }).map((_, i) => (
        <div key={i} className="border-b border-border/35 last:border-b-0">
          <PulsingRow columns={`hidden lg:grid ${columns} items-center min-h-14`} count={count} />
        </div>
      ))}
    </div>
  )
        ...
        <section className="space-y-3">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <TableSkeleton columns="lg:grid-cols-[minmax(15rem,1.5fr)_7rem_0.6fr_0.7fr_0.75fr_0.75fr_7rem]" count={7} rowCount={8} />
            </div>
          </div>
        </section>
      </main>
              ...
              <div className="flex h-full flex-col rounded-md border-0 bg-card py-0 shadow-none ring-0">
                <div className="flex h-11 shrink-0 items-center justify-between gap-3 border-b border-border/45 px-3">
                  <div className="flex h-full w-full items-center gap-6 overflow-x-auto">
                    {Array.from({ length: 3 }).map((_, i) => (
                      <PulsingBlock key={i} className="h-4 w-16 shrink-0 rounded" />
                    ))}
                  </div>
                </div>
                <div className="min-h-0 flex-1 overflow-auto px-3 py-3">
                  <div className="min-w-[54rem]">
                    <div className="grid grid-cols-[minmax(13rem,1.8fr)_5.25rem_7rem_6.5rem_minmax(7rem,1fr)_5.5rem] gap-4 px-3 py-2 bg-muted/45">
                      {Array.from({ length: 6 }).map((_, i) => (
                        <PulsingBlock key={i} className="h-2.5 rounded" />
                      ))}
                    </div>
        ...
        <section className="space-y-3">
          <div className="flex flex-col gap-4">
            ...
            <div className="overflow-hidden rounded-md bg-card py-0 shadow-none ring-0">
              <div className="hidden lg:grid lg:grid-cols-[minmax(16rem,1.6fr)_1fr_0.75fr_0.85fr_7rem] items-center border-b border-border/25 px-3 py-2">
                {Array.from({ length: 5 }).map((_, i) => (
                  <PulsingBlock key={i} className="h-2.5 rounded" />
                ))}
              </div>
              {Array.from({ length: 8 }).map((_, i) => (
                <div key={i} className="border-b border-border/35 last:border-b-0">
                  <div className="hidden lg:grid lg:grid-cols-[minmax(16rem,1.6fr)_1fr_0.75fr_0.85fr_7rem] items-center min-h-14 px-3 py-2">
                    ...
                    {Array.from({ length: 3 }).map((__, j) => (
                      <PulsingBlock key={j} className="h-3 rounded border-l border-border/25 pl-3 text-right" />
                    ))}
              ...
              <div className="flex h-full flex-col rounded-md border-0 bg-card py-0 shadow-none ring-0">
                ...
                <div className="min-h-0 flex-1 overflow-auto px-3 py-3">
                  <div className="min-w-[52rem]">
                    <div className="grid grid-cols-[minmax(12rem,1.8fr)_7rem_6rem_6rem_7rem_7rem_5.5rem] gap-4 px-3 py-2 bg-muted/45">
          ...
          <div className="grid gap-3 xl:grid-cols-[minmax(0,25rem)_minmax(0,1fr)]">
            <div className="gap-2 rounded-md border-0 bg-card pt-3 shadow-none ring-0">
              <div className="grid gap-4 px-3 py-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="min-w-0 rounded-md bg-muted/35 px-2.5 py-2">
          ...
          <div className="min-h-96 overflow-hidden rounded-md border-0 bg-card py-0 shadow-none ring-0">
            ...
            <div className="hidden lg:block">
              <div className="min-w-[62rem]">
                <div className="grid grid-cols-[minmax(14rem,1.8fr)_4rem_7rem_5rem_5rem_7rem_7rem_7rem_5rem] gap-4 px-3 py-2 bg-muted/35">
        ...
        <section className="space-y-3">
          ...
          <div className="rounded-md border-0 bg-card py-0 shadow-none ring-0">
            ...
            <div className="px-0 py-0">
              <div className="hidden px-3 py-2 md:grid md:grid-cols-[0.7fr_1fr_1fr_1fr_0.7fr] items-center bg-muted/35">
                {Array.from({ length: 5 }).map((_, i) => (
                  <PulsingBlock key={i} className="h-2.5 rounded" />
                ))}
              </div>
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} className="grid gap-1.5 px-3 py-2.5 md:grid-cols-[0.7fr_1fr_1fr_1fr_0.7fr] md:items-center border-b border-border/25 last:border-b-0">
