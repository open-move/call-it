...
function getAssetOptions(markets: ProMarket[]): ToolbarOption[] {
...
function filterMarketsByAsset(markets: ProMarket[], selectedAsset?: string) {
  return selectedAsset
    ? markets.filter((market) => market.assetSymbol === selectedAsset)
    : markets
}

function filterMarketsByExpiry(markets: ProMarket[], selectedExpiry?: string) {
  if (!selectedExpiry) {
    return markets
  }
